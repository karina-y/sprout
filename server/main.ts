...
Meteor.startup(() => {
  ...
  //setup accounts
  Accounts.validateLoginAttempt(function (options: any) {
    /* options:
  ...
  process.env.MAIL_URL =
    "smtp://" +
    encodeURIComponent(Meteor.settings.private.awsSmtp.mail_username) +
    ":" +
    encodeURIComponent(Meteor.settings.private.awsSmtp.mail_password) +
    "@" +
    encodeURIComponent(Meteor.settings.private.awsSmtp.mail_server) +
    ":" +
    Meteor.settings.private.awsSmtp.mail_port;

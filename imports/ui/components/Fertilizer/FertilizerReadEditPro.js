  ...
  <div className="swipe-slide">
    ...
    {props.editing === UpdateTypes.fertilizer.fertilizerEditModal ? (
        ...
        <SwipePanelContent icon="fertilizer">
          <p className="modern-input">
            ...
            <input
              ...
              defaultValue={props.item.preferredFertilizer || ""}
            />
          </p>
        </SwipePanelContent>
        ...
        <SwipePanelContent icon="compost">
          <p className="modern-input">
            ...
            <input
              ...
              defaultValue={props.item.compost || ""}
            />
          </p>
        </SwipePanelContent>
        ...
        <SwipePanelContent icon="nutrients">
          <p className="modern-input">
            ...
            <input
              ...
              defaultValue={props.item.nutrient || ""}
            />
          </p>
        </SwipePanelContent>
      </React.Fragment>
      ...
      <React.Fragment>
        ...
        >
          <p>
            {props.item.fertilizerSchedule != null
              ? `Feed every ${props.item.fertilizerSchedule} days`
              : "No schedule set"}
          </p>
...
export default FertilizerReadEditPro;

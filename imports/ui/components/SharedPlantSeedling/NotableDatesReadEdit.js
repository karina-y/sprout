    ...
    <SwipePanelContent icon="schedule">
      <p className="modern-input">
        ...
        <input
          ...
          defaultValue={props.seedling.startDate || ""}
        />
      </p>
    </SwipePanelContent>
    ...
    <SwipePanelContent icon="schedule">
      <p className="modern-input">
        ...
        <input
          ...
          defaultValue={props.seedling.sproutDate || ""}
        />
      </p>
    </SwipePanelContent>
    ...
    <SwipePanelContent icon="schedule">
      <p className="modern-input">
        ...
        <input
          ...
          defaultValue={props.seedling.trueLeavesDate || ""}
        />
      </p>
    </SwipePanelContent>
    ...
    <SwipePanelContent icon="schedule">
      <p className="modern-input">
        ...
        <input
          ...
          defaultValue={props.seedling.transplantDate || ""}
        />
      </p>
    </SwipePanelContent>
    ...
    <SwipePanelContent icon="schedule">
      <p className="modern-input">
        ...
        <input
          ...
          defaultValue={props.seedling.estHarvestDate || ""}
        />
      </p>
    </SwipePanelContent>
    ...
    <SwipePanelContent icon="schedule">
      <p className="modern-input">
        ...
        <input
          ...
          defaultValue={props.seedling.actualHarvestDate || ""}
        />
      </p>
    </SwipePanelContent>

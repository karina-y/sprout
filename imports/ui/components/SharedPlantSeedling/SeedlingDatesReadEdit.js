        ...
        <SwipePanelContent icon="sowDate">
          <p className="modern-input">
            ...
            <input
              ...
              defaultValue={
                props.seedling.sowDate
                  ? new Date(props.seedling.sowDate).toJSON().slice(0, 10)
        ...
        <SwipePanelContent icon="schedule" iconTitle="sprout date">
          <p className="modern-input">
            ...
            <input
              ...
              defaultValue={
                props.seedling.sproutDate
                  ? new Date(props.seedling.sproutDate).toJSON().slice(0, 10)
                  : new Date().toJSON().slice(0, 10)
              }
            />
          </p>
        ...
        <SwipePanelContent icon="trueLeavesDate">
          <p className="modern-input">
            ...
            <input
              ...
              defaultValue={
                props.seedling.trueLeavesDate
                  ? new Date(props.seedling.trueLeavesDate).toJSON().slice(0, 10)
                  : new Date().toJSON().slice(0, 10)
              }
            />
          </p>
        ...
        <SwipePanelContent icon="schedule" iconTitle="estimated harvest date">
          <p className="modern-input">
            ...
            <input
              ...
              defaultValue={
                props.seedling.estHarvestDate
                  ? new Date(props.seedling.estHarvestDate).toJSON().slice(0, 10)
                  : new Date().toJSON().slice(0, 10)
              }
            />
          </p>
        ...
        <SwipePanelContent icon="schedule" iconTitle="actual harvest date">
          <p className="modern-input">
            ...
            <input
              ...
              defaultValue={
                props.seedling.actualHarvestDate
                  ? new Date(props.seedling.actualHarvestDate).toJSON().slice(0, 10)
                  : new Date().toJSON().slice(0, 10)
              }
            />
          </p>

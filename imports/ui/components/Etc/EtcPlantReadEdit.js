      ...
      <React.Fragment>
        ...
        <SwipePanelContent icon="category">
          <p className="modern-input">
            ...
            <select
              onChange={(e) => props.updateData(e, "category")}
        ...
        <SwipePanelContent icon="toxicity">
          <p className="modern-input">
            ...
            <input
              ...
              defaultValue={props.plant.toxicity || ""}
            />
          </p>
        </SwipePanelContent>
        ...
        <SwipePanelContent icon="locationBought">
          <p className="modern-input">
            ...
            <input
              ...
              defaultValue={props.plant.locationBought}
            />
          </p>
        </SwipePanelContent>
            ...
            <input
              ...
              defaultValue={
                props.plant.dateBought
                  ? new Date(props.plant.dateBought).toJSON().slice(0, 10)
            ...
            <input
              ...
              defaultValue={
                props.plant.datePlanted
                  ? new Date(props.plant.datePlanted).toJSON().slice(0, 10)
                  : new Date().toJSON().slice(0, 10)
              }
            />
          </p>
        ...
        <SwipePanelContent icon="companions">
          <p className="modern-input">
            ...
            <input
              ...
              defaultValue={props.plant.companions ? props.plant.companions.join(", ") : null}
            />
          </p>
        </SwipePanelContent>

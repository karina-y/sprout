      ...
      <React.Fragment>
        <SwipePanelContent icon="info" iconTitle="common name">
          <p className="modern-input">
            ...
            <input
              ...
              value={props.seedling.commonName || ""}
            />
          </p>
        </SwipePanelContent>
        ...
        <SwipePanelContent icon="info" iconTitle="latin name">
          <p className="modern-input">
            ...
            <input
              ...
              value={props.seedling.latinName || ""}
            />
          </p>
        </SwipePanelContent>
        ...
        <SwipePanelContent icon="toxicity">
          <p className="modern-input">
            ...
            <input
              ...
              defaultValue={props.seedling.toxicity || ""}
            />
          </p>
        </SwipePanelContent>
        ...
        <SwipePanelContent icon="indoorOutdoor">
          <p className="modern-input">
            ...
            <select
              onChange={(e) => props.updateData(e, "startedIndoorOutdoor")}
        ...
        <SwipePanelContent icon="seedBrand">
          <p className="modern-input">
            ...
            <input
              ...
              value={props.seedling.seedBrand || ""}
            />
          </p>
        </SwipePanelContent>

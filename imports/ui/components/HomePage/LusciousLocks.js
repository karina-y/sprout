		...
		<div className="LusciousLocks panel" id="lusciousLocks">
		  ...
		  <div className="right-panel text-panel panel-title-container">
			<h2 className="panel-title">
			  Let down those luscious locks
			</h2>

			<p className="subtitle">
			  By tracking your watering and fertilizing habits, maintaining optimal soil moisture, and singing to your plants, they'll grow the most beautiful luscious locks!

...
const LegalStuff = () => (
  <div className="LegalStuff">
    ...
    <div className="credit-item">
      Plant loading gif found online, if you created this gif and would like credit or for me to
      remove it, please contact me.
    </div>
    ...
    <div className="credit-item">
      I don't collect your data. Your plant information is stored on a secure cloud database. All
      passwords are encrypted. The only data collected is the data entered and it is only for your
      use, I do not sell or use the information in any way.
      <br />

...
export const Icons: IIcons = {
  ...
  compost: {
    icon: "/icons/farm_03/fertilizer.svg",
    alt: "fertilizer bag",
    title: "compost",
    isCustom: true,
  },
  deadheading: {
    icon: "/icons/farm_01/025-harvest.svg",
    alt: "deadheading plant",
    title: "deadheading",
    isCustom: true,
  },
  ...
  locationBought: {
    icon: faMapMarker,
    alt: "map marker",
    title: "location bought",
    isCustom: false,
  },
  nutrients: {
    icon: faLeaf,
    alt: "leaf",
    title: "other nutrient amendment",
    isCustom: false,
  },
  ...
  pruning: {
    icon: "/icons/farm_01/009-clipper.svg",
    alt: "pruning shears",
    title: "pruning",
    isCustom: true,
  },
  ...
  water: {
    icon: "/icons/farm_01/046-watering can.svg",
    alt: "watering can",
    title: "watering preference",
    isCustom: true,
  },
  tilling: {
    icon: "/icons/farm_01/017-farming tools.svg",
    alt: "farming tools",
    title: "tilling",
    isCustom: true,
  },
  ...
  waterAuto: {
    icon: faHistory,
    alt: "auto",
    title: "automatic watering schedule",
    isCustom: false,
  },
  indoorOutdoor: {
    icon: "/icons/farm_01/039-sprout.svg",
    alt: "plant growing",
    title: "method to start seed",
    isCustom: true,
  },
  methodSeedStart: {
    icon: "/icons/farm_02/019-hand-seed.svg",
    alt: "planting seeds",
    title: "started indoor or outdoor",
    isCustom: true,
  },
  seedBrand: {
    icon: "/icons/farm_02/018-signal.svg",
    alt: "sign",
    title: "seed brand",
    isCustom: true,
  },
  trueLeavesDate: {
    icon: "/icons/farm_03/leaves.svg",
    alt: "leaves",
    title: "true leaves date",
    isCustom: true,
  },
